...
export default function Step2({ onNext }: { onNext: () => void }) {
  return (
    <View style={styles.container}>
      <Image source={require("../Components/Images/onboarding2.png")} style={styles.image} />

      <Text style={styles.title}>Track Your Progress</Text>
      <Text style={styles.description}>
        Monitor your workouts, calories burned, and improvements with AI-powered insights.
      </Text>
